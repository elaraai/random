...
class Random {
    constructor(rng) {
        ...
        this.normal = (mu, sigma) => {
            return (0, normal_1.default)(this, mu, sigma);
        };
        /**
        ...
        this.logNormal = (mu, sigma) => {
            return (0, log_normal_1.default)(this, mu, sigma);
        };
        // --------------------------------------------------------------------------
         ...
         */
        this.bernoulli = (p) => {
            return (0, bernoulli_1.default)(this, p);
        };
        /**
         ...
         */
        this.binomial = (n, p) => {
            return (0, binomial_1.default)(this, n, p);
        };
        /**
         ...
         */
        this.geometric = (p) => {
            return (0, geometric_1.default)(this, p);
        };
        // --------------------------------------------------------------------------
         ...
         */
        this.poisson = (lambda) => {
            return (0, poisson_1.default)(this, lambda);
        };
        /**
        ...
        this.exponential = (lambda) => {
            return (0, exponential_1.default)(this, lambda);
        };
        // --------------------------------------------------------------------------
        // Misc distributions
        // --------------------------------------------------------------------------
         ...
         */
        this.irwinHall = (n) => {
            return (0, irwin_hall_1.default)(this, n);
        };
        /**
         ...
         */
        this.bates = (n) => {
            return (0, bates_1.default)(this, n);
        };
        /**
         ...
         */
        this.pareto = (alpha) => {
            return (0, pareto_1.default)(this, alpha);
        };
    ...
    clone(...args) {
        if (args.length) {
            return new Random((0, rng_factory_1.default)(...args));
        }
        else {
     ...
     */
    use(...args) {
        this._rng = (0, rng_factory_1.default)(...args);
    }
    /**
